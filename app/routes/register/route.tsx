            ...
            .pipe(
               z.string().superRefine((username, ctx) =>
                  refine(ctx, {
                     ...
                     when:
                        intent === 'submit' || intent === 'validate/username',
   ...
   return (
      <div className="max-w-sm mx-auto pt-2">
         ...
         <Form method="post" {...form.props}>
            ...
            {username.error && (
               <ErrorMessage
                  message={{ id: username.id, error: username.error }}
               />
            )}
            <span className="block mb-4">
               ...
               <span id="usernameDesc" className="text-sm text-gray-500">
                  Username must be at least 10 characters long and must not
            ...
            {password.error && (
               <ErrorMessage
                  message={{ id: password.id, error: password.error }}
               />
            )}
            <span className="block mb-4">
               <Input
